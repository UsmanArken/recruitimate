...
if celery is None:
    # Celery not installed — provide a stub so callers can do score_candidate.delay(...)
    class _Stub:
        def delay(self, *args, **kwargs):
            logger.warning("Celery not available — skipping background scoring task")

    score_candidate = _Stub()
