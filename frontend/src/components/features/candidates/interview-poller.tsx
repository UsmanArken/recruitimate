...
export function InterviewPoller({ active }: { active: boolean }) {
  ...
  return (
    <div className="flex items-center gap-2 rounded-lg border border-border-subtle bg-card px-4 py-3 text-sm text-muted shadow-sm">
      <Loader2 className="h-4 w-4 animate-spin text-interview" />
      Analysing interview — results will appear automatically…
    </div>
  );
}
